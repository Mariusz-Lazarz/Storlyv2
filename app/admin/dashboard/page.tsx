...
const AdminDashboardPage = () => {
  return (
    <div className="grid grid-cols-5 grid-rows-4 gap-4 h-full">
      <div className="bg-white border-[0.5px] shadow-lg rounded-lg col-span-1 row-span-1">
        <EcommerceRevenue />
      </div>
      <div className="bg-white border-[0.5px] shadow-lg rounded-lg col-span-1 row-span-1">
        <AverageOrderValue />
      ...
      <div className="bg-white border-[0.5px] shadow-lg rounded-lg col-span-2 row-span-2">
        <MostSellingProducts />
      </div>

      <div className="bg-white border-[0.5px] shadow-lg rounded-lg col-span-3 row-span-3">
        <RecentOrders />
      </div>
